...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "julienmorali-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/telecommande-express"
  #   chef.validation_client_name = "telecommande-express-validator"
  #   chef.validation_key_path = ".chef/telecommande-express-validator.pem"
  # end
end
